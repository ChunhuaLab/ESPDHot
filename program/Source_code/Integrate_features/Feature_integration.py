...
##coevolution
coevo = pd.read_csv('./Input/'+pdbnum+"_coevolution.csv", encoding = 'utf-8', sep = ',', quoting = 1)
coevo['pos'] = position
# CX/DPX
...
# ASA
ASA_bound = open("./Input/" + pdbnum + "_bound.rsa", 'r')
...
ASA_unbound = open("./Input/" + pdbnum + '_unbound.rsa', 'r')
